...
proyección Equirectangular sobre el área cubierta mencionada anteriormente. Es decir, dado que los datos son del continente europeo se recortaron las coordenadas correspondientes al territorio continental de España. Además, el dataset divide los datos en las cuatro estaciones del año, nosotros nos quedamos con la primavera.   
...
Se extrae entonces del archivo GDX la grilla (matrix) completa de 70x130, que van a representar 9100 puntos correspondientes al continente europeo, en el año y estación mencionada. Estos datos se guardan en formato csv para que luego se puedan trabajar en R para su posterior procesamiento.
...
Se quitaron de la grilla los puntos pertenecientes a otros países. Para esto utilizamos un _shp_ de España e iterativamente se fueron removiendo los puntos externos al país.
...
de españa, con lo que vamos a definir un _boundary box_ de 1 grado menos en cada limite
